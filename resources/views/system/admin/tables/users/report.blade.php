...
@section('tableTitle')
	Usuarios <a href="formUpUser"><i class="fas fa-plus-circle text-success"></i></a> 
@stop
...
@section('records')
  ...
  @foreach ($report as $r)
    ...
    <td>********</td>
	 <td>
		<a href="{{ URL::action('UserController@lock',['id'=>$r->id]) }}"><div class="btn btn-danger"><i class="fas fa-lock "></i></div></a>
          <a href="{{ URL::action('UserController@formModify',['id'=>$r->id]) }}"><i class="fas fa-edit btn btn-warning"></i></a>

  	<!-- Modal De informacion de User-->
